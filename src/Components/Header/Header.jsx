        ...
        <>
          ...
          <div className="menu_hamburguesa">
            ...
            <div className="curriculums">
              ...
              <a
                href="/assets/pdf/Cv_Mozetich_Cristian.pdf"
                target="_blank"
                className="btn_submenu"
              >
                <i class="fa-regular fa-file"></i>
                {traduccionActual.CvEspaño}
              </a>
              <a
                href="/assets/pdf/Cv_Mozetich_Cristian_EN.pdf"
                target="_blank"
                className="btn_submenu"
              >
                <i class="fa-regular fa-file"></i>
                {traduccionActual.CvIngles}
              </a>
              <a
                href="/assets/pdf/Cv_Mozetich_Cristian_IT.pdf"
                target="_blank"
                className="btn_submenu"
              >
                <i class="fa-regular fa-file"></i>
                {traduccionActual.CvItaliano}
              </a>
            </div>
          </div>
        </>
