    ...
    <div className='intro_desc'>
      {idioma === 'ingles' && (
        <>
          ...
          <p>I am a <mark>full stack developer MERN.</mark> Here you can find all the relevant links and a selection of my latest projects.</p>
        </>
      )}
      {idioma === 'español' && (
        <>
          <h1 className='titulo'>Hola, soy Cristian &#x1F44B;</h1>
          <p>Soy <mark>desarrollador full stack MERN.</mark> Aquí puedes encontrar todos los enlaces relevantes y una selección de mis últimos proyectos.</p>
        </>
      )}
      {idioma === 'italiano' && (
        <>
          <h1 className='titulo'>Ciao, sono Cristian &#x1F44B;</h1>
          <p>Sono <mark>sviluppatore full stack MERN.</mark> Qui puoi trovare tutti i link rilevanti e una selezione dei miei ultimi progetti.</p>
        </>
      )}
        <li>
